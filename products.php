...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our GreenAgri Store!</h1>
                    <p>We have the best Fertilizers, organic and Chemical for you.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\humigold-back_300x.jpg" alt="humigold">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>HumiGold</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\Theeta_new1_300x.jpg" alt="Theeta">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Theeta</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\sonata-box_300x.jpg" alt="SUPER SONATA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Super sonata</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\biovitax.jpg" alt="biovitax">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>biovitax</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\remore-250x250.jpg" alt="remore">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>remore</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\thrips-controller-500x500.jpg" alt="Thrips Controller">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Thrips Controller</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\bindu--500x500.png" alt="Bio-Tech Grade Bindu-Silicon Liquid">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bio-Tech Grade Bindu-Silicon Liquid</h3>
                                    <p>Price: Rs. 2290.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\bottle-mockup-01-500x500.jpg" alt="DC 80 Plus Chemical">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>DC 80 Plus Chemical</h3>
                                    <p>Price: Rs. 400.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\unisa-82-250x250.jpg" alt="Chemical Grade Unisa-82">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Chemical Grade Unisa-82</h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\prod-20201230-1248383404545666445800712-jpg-250x250.jpg" alt="Monarch Agricultural Active Silicone Spreader">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Monarch Silicone Spreader</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\mycorrhiza-bio-fertilizer-250x250.jpg" alt="Mycorrhiza Bio Fertilizer">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Mycorrhiza Bio Fertilizer</h3>
                                    <p>Price: Rs. 1200.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img\root-inducer-250x250.jpg" alt="Mother Biotech Root Inducer">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Mother Biotech Root Inducer</h3>
